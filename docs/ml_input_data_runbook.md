...
12. For the April 2026 Cu/Ni full-cycle configs, `benchmark_batch_size` in the top-level workflow YAML controls the training batch size for the entire benchmark suite.
