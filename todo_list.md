...
- [x] M11c: Add dedicated `.oh5` crop GUI with multi-rectangle IQ-map selection, batch cropped export, and automatic post-export original-vs-cropped review workspace with crop selector.
...
- [x] M23a: Upgrade the full-scan clicked-pixel inspector to keep original and processed Kikuchi views visible with synchronized fit/zoom/pan controls.
...
- [x] ML diagnostic gallery backend test for session build, manual additions, and manifest/contact-sheet export.
...
- [x] Add usage docs for dedicated `.oh5` crop and review GUI.
