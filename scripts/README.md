...
- `scripts/run_ml_oh5_sample_inference.py` (sample filtered patterns from unseen `.oh5` scans, run saved CNN inference, and write per-pattern plus per-scan summary tables)
